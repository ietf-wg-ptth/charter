...
* Protocol mechanisms for requesting additional capacity from transport-layer clients/HTTP servers

## Milestones

Working Group adoption of an initial draft specification: X months from chartering
Working Group Last Call: Y months from chartering
Submission to the IESG for publication as a Proposed Standard: Z months from chartering

## Liaison

The PTTH Working Group will coordinate closely with the HTTP Working Group (HTTPBis), to ensure architectural alignment with existing and future versions of HTTP.
